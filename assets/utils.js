...
// const sectionCurrentViewObj = {
//     domMap:{},
//     observerBtn: null,
//     init: function () {
//         if(this.observerBtn)return;
//         this.observerBtn = new IntersectionObserver(function(entries){
//             console.log("entries", entries)
//             entries.forEach( function(element, index) {
//                 if (element.isIntersecting) {
//                     console.log("element", element)
//                     console.log("isOnce2", isOnce)
//                    let dom = target;
//                    let callback = this.domMap[dom];
//                    callback();
//                    if(!isOnce) {
//                         isOnce = true
//                         callback && callback()
...
//                         // 解绑监视器
//                         // observerBtn.unobserve(entries.target)
//                    }
//                 } else {
//                 }
//             });
...
//         this.domMap.dom = callback;
//         this.domMap[dom] = callback;
//         this.observerBtn.observe(dom)
//     }
// }
