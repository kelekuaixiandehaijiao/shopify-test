    ...
    const fbBikeAddToCart = {
        ...
        loadAjax: function () {
            ...
            fetch(fbShopifyRoot + 'cart/add.js', {
                ...
                this.clickGtm(_this.selectQuery.price);
        ...
        clickGtm: function (price) {
            ...
            gtag('event', 'conversion', {
              send_to: 'AW-10865413813\/XfaQCNvIroAYELWdhL0o',
              value: _price,
              currency: Shopify.currency.active,
            });
            console.log('clickGtm', _price);
            console.log('clickGtm', Shopify.currency.active);
          },
        ...
        getSoldOut: function () {
            let _this = this
            if(window.location.pathname.indexOf('commercial-bike') > -1) { 
              return false
            }
        ...
        changeImgSlide: function () {
            ...
            $(`#ebike-product-${_this.selectQuery.id}`).find('.Product__SlideItem--image').each(function(index, ele) {
                ...
                let str = `
                <div class="swiper-slide"><div class="ebike-zoom-relative swiper-zoom-container relative">
        ...
        event: function () {
            ...
            // $('.js-ebike-addtocart').click(function (e) {
                ...
                if($('.js-ebike-sing-up').length) {
                    ...
                    return false
                }else if($('#fb-commerical').length) {
                    $('html, body').animate({
                          // scrollTop:$('#fb-commerical').offset().top
                          scrollTop: Math.trunc($('#fb-commerical').offset().top - allHeaderHeight)
                    }, 1000); // 滚动到目
                    return false
                }
                // 临时测试end
