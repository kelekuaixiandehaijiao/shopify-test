  $(function () {
      ...
      FbActiveRoll.prototype = {
          ...
          swiperFun: function () {
              ...
              const swiper = new Swiper(swiperName, {
                  ...
                  on: {
                    ...
                    //     console.log("2121", swiper)
                    // },
                    // getTranslate: function(swiper, translate) {
                    //   _this.visibleFun(translate)
                    //   // console.log("getTranslate", swiper, translate)
                    // },
          ...
          // navigation: {
          //   nextEl: `${_this._Id} .activeroll-button-next`,
          //   prevEl: `${_this._Id} .activeroll-button-prev`,
          // },
