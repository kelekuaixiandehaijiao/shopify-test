  ...
  var NewsletterPopupSection = /*#__PURE__*/function () {
    ...
    _createClass(NewsletterPopupSection, [{
      ...
      value: function _attachListeners() {
        ...
        console.log(123);
        this.delegateElement.on('click', '[data-action="zoom-popup"]', this._closePopup1.bind(this));
        console.log(123);
      }
    }, {
      key: "_attachListeners1",
      value: function _attachListeners1() {
        console.log(000);
//         this.delegateElement.on('click', '[data-action="close-popup"]', this._closePopup.bind(this));
        console.log(123);
        this.delegateElement.on('click', '[data-action="zoom-popup"]', this._closePopup.bind(this));
        console.log(123);
      }
    }, {
      key: "_openPopup",
