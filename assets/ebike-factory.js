$(function() {
    ...
    var fbFactoryNavBarPc = 1211
    var fbFactoryNavBarMob = 1210
    ...
    if(document.querySelector('[data-section-type="customer-product"]')) {
        ...
        var teemo_customer_video_dom = document.querySelectorAll('[data-media-type="video"], [data-media-type="external_video"]')
    ...
    const fixedTop = {
        ...
        init: function() {
            ...
            $('#shopify-section-announcement').css('position', 'fixed')
            $('.PageContainer').css('padding-top', ($('#shopify-section-announcement').height() + $('#shopify-section-header').height()) + 'px')
            if(isEbikePdp) {
