...
$(function () {
    const fbClasses = {
        init:function(){
            ...
            var $downloadIcon = $(".download-left-bottom-icon");
            if(shopify_country_code=='GB'){
                $downloadIcon.find("a:first").attr("href", "https://apps.apple.com/gb/app/freebeat/id6450832508");
            }
            if(shopify_country_code=='AU'){
                $downloadIcon.find("a:first").attr("href", "https://apps.apple.com/us/app/freebeatfit/id6450832508");
            }
            // 找到第一个 <a> 标签并替换 href 属性的值
            console.log(shopify_country_code,'城市的代码')
        }
    }
    fbClasses.init()
    do {
