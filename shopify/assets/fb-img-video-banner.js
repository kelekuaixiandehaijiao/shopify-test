$(function () {
  if (window.location.pathname == "/") {
    var eBikeButton = document.getElementById(
      "gtm-homeSlideshow-xBikeButton-GET EBIKE",
    );
    if(eBikeButton) {
      eBikeButton.addEventListener("click", function () {
        // 调用 customGaEvent 函数并传递事件信息
        customGaEvent("homepagebanner", "click", "eBike_2in1_Original_Clicks");
      });
    }
  }
      ...
      const swiperSingleGoods = new Swiper(swiperName, {
        ...
        on: {
          slideChange: function () {
            ...
            let _current = $(
              `${_this._Id} .js-homebanner-slid[data-number=${realIndex}]`,
            );
            ...
            if (type === "video_banner") {
              ...
              let video_all = $(
                `${_this._Id} .js-homebanner-slid[data-type=video_banner]`,
              );
